...
<section  id="inicio">
	<h2 class="text-center text-secondary mb-0">Equipes</h2>
	<hr class="star-dark mb-5">
    <div class="bg-gold container">
				...
				?>
						<div class="col-lg-4 text-center">
							...
							<?php
								...
								echo "<img class='rounded-circle displayed' src = \" data:image/JPG;charset=utf8;base64,";
					        	echo $img;
					        	echo "\" class=\"eq\" alt=\"imagem do projeto\" width='200' height='200' />";
							?>
		 
							<h3> <?= $aluno->getNome() ?> </h3>
							<p> <?= $aluno->getDescricao() ?> </p>
						</div>
